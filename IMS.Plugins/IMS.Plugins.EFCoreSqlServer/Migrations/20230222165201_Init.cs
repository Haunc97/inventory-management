...
namespace IMS.Plugins.EFCoreSqlServer.Migrations
{
    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "InventoryTransations",
                columns: table => new
                {
                    InventoryTransationId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InventoryTransations", x => x.InventoryTransationId);
                    table.ForeignKey(
                        name: "FK_InventoryTransations_Inventories_InventoryId",
            ...
            migrationBuilder.CreateTable(
                name: "ProductTransations",
                columns: table => new
                {
                    ProductTransationId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ProductionNumber = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductTransations", x => x.ProductTransationId);
                    table.ForeignKey(
                        name: "FK_ProductTransations_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "ProductId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InventoryTransations_InventoryId",
                table: "InventoryTransations",
                column: "InventoryId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductTransations_ProductId",
                table: "ProductTransations",
                column: "ProductId");
        }
